        ...
        >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mt-12">
            ...
            <div className="space-y-6 order-2 lg:order-1">
              <div className="bg-white dark:bg-gray-800/50 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-lg dark:shadow-none">
                <h3 className="text-xl font-bold text-blue-600 dark:text-blue-400 mb-4">
                  {language === 'es' ? 'Experiencia Actual' : 'Current Experience'}
                </h3>
                <p className="text-gray-700 dark:text-gray-300 mb-2">{data.currentRole}</p>
              ...
              <div className="bg-white dark:bg-gray-800/50 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-lg dark:shadow-none">
                ...
                <div className="space-y-4">
                  {data.education.map((edu, index) => (
                    <div key={index}>
                      <p className="text-gray-700 dark:text-gray-300 mb-2">{edu.title}</p>
                      <p className="text-sm text-gray-500 dark:text-gray-400">
                        {edu.period}
                      </p>
                    </div>
              ...
              <div className="bg-white dark:bg-gray-800/50 rounded-lg p-6 border border-gray-200 dark:border-gray-700 shadow-lg dark:shadow-none">
                ...
                <ul className="space-y-2">
                  {data.certifications.map((cert, index) => (
                    <li key={index} className="text-gray-700 dark:text-gray-300 list-disc list-inside">
                      {cert}
                    </li>
                  ))}
                </ul>
            ...
            <div className="space-y-8 order-1 lg:order-2">
              ...
              <div>
                <h4 className="text-lg font-semibold text-gray-900 dark:text-white mb-3 pt-4 text-center lg:text-left">
                ...
                <div className="flex flex-wrap gap-2 justify-center lg:justify-start">
                  {data.skills.map((skill, index) => (
                    <span
                      key={index}
                      className="bg-blue-100 dark:bg-blue-600/20 text-blue-700 dark:text-blue-300 px-3 py-1 rounded-full text-sm border border-blue-200 dark:border-blue-600/30"
                    >
                      {skill}
                    </span>
                  ))}
